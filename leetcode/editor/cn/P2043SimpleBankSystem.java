...
// 
//
// Related Topics 设计 数组 哈希表 模拟 👍 59 👎 0
...
public class P2043SimpleBankSystem {
    public static void main(String[] args) {
        // Solution solution = new P2043SimpleBankSystem().new Solution();
        // TO TEST
    ...
    class Bank {
        ...
        public boolean transfer(int account1, int account2, long money) {
            if (account1 > 0 && account1 <= this.count && account2 > 0 && account2 <= this.count && this.balance[account1 - 1] >= money) {
        ...
        public boolean deposit(int account, long money) {
            if (account > 0 && account <= this.count) {
        ...
        public boolean withdraw(int account, long money) {
            if (account > 0 && account <= this.count && this.balance[account - 1] >= money) {
                this.balance[account - 1] -= money;
                return true;
            }
            return false;
